...
class modSaascore extends DolibarrModules
{
    public function __construct($db)
    {
        ...
        $this->menu[$r++] = array(
            ...
            'mainmenu'  => 'home',
            'leftmenu'  => 'saascore',
            'url'       => '/kafo-ERP-Control/admin/index.php',
        ...
        $pages = array(
            'tenant' => array('TenantConfiguration', 910, 'tenantmanage', '/kafo-ERP-Control/admin/tenant.php'),
            'modules' => array('ModulesCatalog', 920, 'write', '/kafo-ERP-Control/admin/modules.php'),
            'features' => array('FeaturesCatalog', 930, 'write', '/kafo-ERP-Control/admin/features.php'),
            'limits' => array('LimitsCatalog', 940, 'write', '/kafo-ERP-Control/admin/limits.php'),
            'permissions' => array('PermissionsCatalog', 950, 'rolemanage', '/kafo-ERP-Control/admin/permissions.php'),
            'bundles' => array('BundlesCatalog', 960, 'write', '/kafo-ERP-Control/admin/bundles.php'),
            'roles' => array('RolesCatalog', 970, 'rolemanage', '/kafo-ERP-Control/admin/roles.php'),
        );
