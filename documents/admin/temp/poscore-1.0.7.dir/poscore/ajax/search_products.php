...
while ($obj = $db->fetch_object($resql)) {
    $rows[] = array('id' => (int) $obj->rowid, 'product' => trim($obj->ref.' - '.$obj->label), 'price' => price2num($obj->price, 'MU'), 'stock' => price2num($obj->stock_qty, 'MU'), 'barcode' => $obj->barcode);
}
