...
print 'urls: {';
print 'searchProducts: "'.dol_buildpath('/custom/poscore/ajax/search_products.php', 1).'",';
print 'addToCart: "'.dol_buildpath('/custom/poscore/ajax/add_to_cart.php', 1).'",';
print 'removeFromCart: "'.dol_buildpath('/custom/poscore/ajax/remove_from_cart.php', 1).'",';
print 'clearCart: "'.dol_buildpath('/custom/poscore/ajax/clear_cart.php', 1).'",';
print 'createInvoice: "'.dol_buildpath('/custom/poscore/ajax/create_invoice.php', 1).'"';
print '},';
