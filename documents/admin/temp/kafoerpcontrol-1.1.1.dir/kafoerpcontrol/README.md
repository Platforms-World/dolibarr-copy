...
## 1.1.0
- Added API Access admin screen.
- Added fixed token support through SAAS_API_FIXED_TOKEN.
- Added generated 64-character tokens with read/write/update permissions.
- Added `/custom/kafoerpcontrol/api/access.php` endpoint for reading catalogs and managing direct SaaS user permissions.
