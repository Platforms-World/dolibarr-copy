...
## Install
1. Copy `custom/kafo_ERP_Control` into your Dolibarr `htdocs/custom/` directory.
...
- Fixed admin pages bootstrap path to main.inc.php for /custom/kafo_ERP_Control/admin/*.php
