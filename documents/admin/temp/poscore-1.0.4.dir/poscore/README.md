...
## Upgrade note
- This version fixes Dolibarr rights registration in llx_rights_def by defining rights type indexes correctly.
- Disable and re-enable the module after replacing files.
