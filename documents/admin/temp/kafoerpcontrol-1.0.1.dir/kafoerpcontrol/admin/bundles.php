    ...
    if ($code !== '') {
        ...
        if ($db->query($sql)) {
            saascoreAuditLogAction(
                ...
                $code,
                null,
                json_encode(array('label' => $label, 'is_active' => (int) $is_active)),
                'Bundle catalog item added',
                array('context' => 'admin/bundles.php')
            );
        }
    }
}
...
print dol_get_fiche_head(saascoreAdminPrepareHead(), 'bundles', 'kafo-ERP-Control', -1, 'generic');
