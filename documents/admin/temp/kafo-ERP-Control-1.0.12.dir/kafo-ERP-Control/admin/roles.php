...
require_once dol_buildpath('/kafo-ERP-Control/core/lib/saascore.lib.php', 0);
require_once dol_buildpath('/kafo-ERP-Control/class/SaasRoleService.php', 0);
...
print dol_get_fiche_head(saascoreAdminPrepareHead(), 'roles', $langs->trans('kafo-ERP-Control'), -1, 'generic');
