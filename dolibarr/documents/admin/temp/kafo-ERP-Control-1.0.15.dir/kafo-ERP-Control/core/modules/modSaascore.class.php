...
class modSaascore extends DolibarrModules
{
    public function __construct($db)
    {
        ...
        $this->langfiles = array('saascore@kafo-ERP-Control');
        $this->config_page_url = array('index.php@kafo-ERP-Control');
        ...
        $this->menu[$r++] = array(
            ...
            'mainmenu'  => 'home',
            'leftmenu'  => 'saascore',
            'url'       => '/custom/kafo-ERP-Control/admin/index.php',
            'langs'     => 'saascore@kafo-ERP-Control',
            'position'  => 900,
        ...
        $pages = array(
            'tenant' => array('TenantConfiguration', 910, 'tenantmanage', '/custom/kafo-ERP-Control/admin/tenant.php'),
            'modules' => array('ModulesCatalog', 920, 'write', '/custom/kafo-ERP-Control/admin/modules.php'),
            'features' => array('FeaturesCatalog', 930, 'write', '/custom/kafo-ERP-Control/admin/features.php'),
            'limits' => array('LimitsCatalog', 940, 'write', '/custom/kafo-ERP-Control/admin/limits.php'),
            'permissions' => array('PermissionsCatalog', 950, 'rolemanage', '/custom/kafo-ERP-Control/admin/permissions.php'),
            'permissionscontrol' => array('PermissionsControl', 955, 'nativerightsmanage', '/custom/kafo-ERP-Control/admin/permissions_control.php'),
            'bundles' => array('BundlesCatalog', 960, 'write', '/custom/kafo-ERP-Control/admin/bundles.php'),
            'roles' => array('RolesCatalog', 970, 'rolemanage', '/custom/kafo-ERP-Control/admin/roles.php'),
        );
    ...
    {
        $sql = array();
        $result = $this->_load_tables('/kafo-ERP-Control/sql/');
        if ($result < 0) {
            return -1;
        }
