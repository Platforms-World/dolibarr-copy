...
class PosSaasBridge
{
    ...
    protected function registryServicePath()
    {
        return DOL_DOCUMENT_ROOT.'/custom/saascore/class/service/SaasRegistryService.php';
    }

    protected function accessServicePath()
    {
        return DOL_DOCUMENT_ROOT.'/custom/saascore/class/service/SaasAccessService.php';
    }

    public function loadRegistryService()
    {
        $file = $this->registryServicePath();
        if (!is_file($file)) {
