...
class modSaascore extends DolibarrModules
{
    public function __construct($db)
    {
        ...
        $this->description = 'Central SaaS entitlement, features, limits and permissions layer';
        $this->descriptionlong = 'Central platform layer for multi-tenant Dolibarr SaaS';
 $this->editor_name = 'PW Company';
        $this->version = '1.0.9';
        ...
        $this->langfiles = array('saascore@saascore');
        $this->config_page_url = array('index.php@saascore');
        ...
        $this->const = array(
            ...
            2 => array('SAASCORE_ENABLE_ROLE_LAYER', 'yesno', '1', 'Enable SaaS role layer', 1, 'current', 1),
        ...
        $this->rights[$r][1] = 'Read SaaS Core setup';
        $this->rights[$r][4] = 'read';
        $r++;
        $this->rights[$r][0] = 105502;
        $this->rights[$r][1] = 'Manage SaaS Core registries';
        ...
        $this->rights[$r][1] = 'Manage SaaS roles and permissions';
        ...
        $this->menu[$r++] = array(
            ...
            'mainmenu'  => 'home',
            'leftmenu'  => 'saascore',
            'url'       => '/saascore/admin/index.php',
            'langs'     => 'saascore@saascore',
            'position'  => 900,
        ...
        $pages = array(
            'tenant' => array('TenantConfiguration', 910, 'tenantmanage', '/saascore/admin/tenant.php'),
            'modules' => array('ModulesCatalog', 920, 'write', '/saascore/admin/modules.php'),
            'features' => array('FeaturesCatalog', 930, 'write', '/saascore/admin/features.php'),
            'limits' => array('LimitsCatalog', 940, 'write', '/saascore/admin/limits.php'),
            'permissions' => array('PermissionsCatalog', 950, 'rolemanage', '/saascore/admin/permissions.php'),
            'bundles' => array('BundlesCatalog', 960, 'write', '/saascore/admin/bundles.php'),
            'roles' => array('RolesCatalog', 970, 'rolemanage', '/saascore/admin/roles.php'),
        );
    ...
    {
        $sql = array();
        $result = $this->_load_tables('/saascore/sql/');
        if ($result < 0) {
            return -1;
        }
