...
TakeposAccess::enforceAdmin($db, $user, 'takepos.admin.other', null);
...
print '<tr class="liste_titre">'."\n";
print '<td colspan="2">' . dol_escape_htmltag($langs->trans('TakeposAdminOtherSupportTitle')) . '</td>';
print '<td>'.$langs->trans("URL").'</td>';
print '</tr>';
...
print '</a></td>';
print '<td>' . dol_escape_htmltag($langs->trans('TakeposAdminOtherPartnersTitle')) . '</td>';
print '<td>';
print '<a href="'.$url.'" target="_blank" rel="noopener noreferrer external">';
print img_picto('', 'url', 'class="pictofixedwidth"');
print $url.'</a></td>';
