...
if ($method === 'POST') {
    ...
    $res = $invoice->addline($product->description, $price, $qty, $tvaTx, $localtax1, $localtax2, $productId, 0, '', 0, 0, 0, 0, $priceBaseType, $priceTtc, $product->type, -1, 0, '', 0, 0, 0, '', array(), 100, 0, null, 0);
    if ($res <= 0) {
