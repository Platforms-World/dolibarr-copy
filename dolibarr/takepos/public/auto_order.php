...
if (!getDolGlobalString('TAKEPOS_AUTO_ORDER')) {
	accessforbidden($langs->trans('TakeposAutoOrderDenied')); // If Auto Order is disabled never allow access to this page (that is a NO LOGIN access)
}

TakeposAccess::enforcePublic($db, 'takepos.auto_order');
