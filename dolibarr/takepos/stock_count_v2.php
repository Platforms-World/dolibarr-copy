...
if (!$user->admin) {
    TakeposAccess::requireFrontendAccess($db, $user, 'takepos.store_governance', 'takepos.store.manage',
        ...
        $langs->trans('TakeposCountAccessDenied'), array('page' => 'stock_count_v2.php'));
}
...
<?php
$v2PageTitle = $langs->trans('TakeposStockCountTitle');
$v2PageIcon  = 'fa-clipboard-check';
...
<div class="wrap">
  ...
  <div class="card">
    ...
    <form method="get" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:10px">
      ...
      <input type="kfv2-hidden" name="warehouse_id" value="<?php echo (int)$warehouseId; ?>">
  ...
  <form method="POST" id="count-form">
    <input type="kfv2-hidden" name="token" value="<?php echo newToken(); ?>">
    <input type="kfv2-hidden" name="action" value="apply_count">
    <input type="kfv2-hidden" name="warehouse_id" value="<?php echo (int)$warehouseId; ?>">
    <input type="kfv2-hidden" name="s" value="<?php echo dol_escape_htmltag($search); ?>">
        ...
        <table>
          ...
          <?php foreach ($products as $i => $p): ?>
            <tr id="row_<?php echo (int)$p->rowid; ?>">
              <input type="kfv2-hidden" name="counted_product_id[]" value="<?php echo (int)$p->rowid; ?>">
              <input type="kfv2-hidden" name="system_qty[]" value="<?php echo (float)$p->system_qty; ?>">
