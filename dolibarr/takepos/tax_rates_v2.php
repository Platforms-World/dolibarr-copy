...
$pageUrl = DOL_URL_ROOT . '/takepos/tax_rates_v2.php';
...
print '<link rel="stylesheet" href="' . DOL_URL_ROOT . '/takepos/css/workspace_v2.css">';
print '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">';
print '<div class="kfv2-page-body" style="max-width:1460px;margin:0 auto;padding:22px 26px 48px">';

print load_fiche_titre($langs->trans('TakeposTaxRatesTitle'), '', 'title_setup');

print '<div class="tabsAction">';
print '<a class="butAction" href="' . dol_escape_htmltag(DOL_URL_ROOT . '/takepos/pos_v2.php') . '">' . dol_escape_htmltag($langs->trans('TakeposCommonBackToPos')) . '</a>';
