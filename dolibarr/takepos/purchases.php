...
TakeposAccess::requireFrontendAccess(
    ...
    array('page' => 'purchases.php')
);

if (!TakeposPurchaseService::canRead($db, $user)) {
    TakeposAccess::denyAccess($db, $user, $langs->trans('TakeposPurchaseReadPermissionRequired'), array('page' => 'purchases.php'));
}
TakeposPurchaseService::ensureSchema($db);

$entity = !empty($user->entity) ? (int) $user->entity : 1;
$pageUrl = DOL_URL_ROOT . '/takepos/purchases.php';
$form = new Form($db);
$messages = array();
$errors = array();
...
$arrayofcss = array('/takepos/css/workspace.css', '/takepos/css/purchases.css');
...
?>
<body class="takepos-workspace-reports-body takepos-purchase-body">
<div class="takepos-workspace-reports-page takepos-purchase-page">
    <div class="takepos-purchase-header-row">
        <h2 class="takepos-workspace-title"><?php echo dol_escape_htmltag($langs->trans('TakeposPurchaseTitle')); ?></h2>
    ...
    <section class="takepos-workspace-panel takepos-purchase-panel">
        <h3><?php echo dol_escape_htmltag($currentPurchase ? $langs->trans('TakeposPurchaseEditReceipt') . ': ' . $currentPurchase->ref : $langs->trans('TakeposPurchaseCreateReceipt')); ?></h3>
    ...
    <?php if ($currentPurchase) { ?>
    <section class="takepos-workspace-panel takepos-purchase-panel">
        <h3><?php echo dol_escape_htmltag($langs->trans('TakeposPurchaseLastReceipt')); ?>: <?php echo dol_escape_htmltag($currentPurchase->ref); ?></h3>
        <div class="takepos-workspace-filter-grid takepos-purchase-grid">
    ...
    <section class="takepos-workspace-panel takepos-purchase-panel">
        <h3><?php echo dol_escape_htmltag($langs->trans('TakeposPurchaseRecentReceipts')); ?></h3>
        <div class="takepos-purchase-table-wrap">
            <table class="noborder takepos-purchase-table compact">
