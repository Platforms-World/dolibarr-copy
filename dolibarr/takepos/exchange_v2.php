...
TakeposAccess::requireFeature($db, 'takepos.returns', $user, false, array('page' => 'exchange_v2.php', 'feature' => 'takepos.returns'));
TakeposAccess::requireFrontendAccess($db, $user, 'takepos.exchanges', 'takepos.use', (int) $terminal, $exchangeAccessDeniedMessage, array('page' => 'exchange_v2.php'));
...
<?php
$v2PageTitle = $langs->trans('TakeposExchangeTitle');
$v2PageIcon  = 'fa-right-left';
...
<div class="kfv2-page-body" style="max-width:1460px;margin:0 auto;padding:22px 26px 48px">
    <h2 style="display:none"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeTitle')); ?></h2>

    <div id="takepos-exchange-config"
         data-token="<?php echo dol_escape_htmltag(newToken()); ?>"
         data-endpoint="<?php echo dol_escape_htmltag(DOL_URL_ROOT . '/takepos/ajax/exchange_v2.php'); ?>"></div>
    ...
    <section class="kfv2-card-block">
        <div class="kfv2-card-block-head"><h3 style="margin:0;font-size:14.5px"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeLookupTitle')); ?></h3></div><div class="kfv2-card-block-body">
        ...
        <div class="kfv2-actions"><button type="button" id="btn_lookup" class="kfv2-btn kfv2-btn-primary"><?php echo dol_escape_htmltag($langs->trans('TakeposCommonSearch')); ?></button></div>
        <div class="kfv2-table-wrap"><table id="table_lookup" class="kfv2-table"></table></div>
    </section>

    <section class="kfv2-card-block">
        <div class="kfv2-card-block-head"><h3 style="margin:0;font-size:14.5px"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeReturnedLines')); ?></h3></div><div class="kfv2-card-block-body">
        <div id="exchange_meta"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeSelectInvoice')); ?></div>
        <div class="kfv2-table-wrap"><table id="table_returns" class="kfv2-table"></table></div>
    </section>

    <section class="kfv2-card-block">
        <div class="kfv2-card-block-head"><h3 style="margin:0;font-size:14.5px"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeReplacementLines')); ?></h3></div><div class="kfv2-card-block-body">
        <div class="kfv2-form-grid">
            ...
            <div><label>&nbsp;</label><button type="button" id="btn_add_new_line" class="kfv2-btn kfv2-btn-outline"><?php echo dol_escape_htmltag($langs->trans('Add')); ?></button></div>
        </div>
        <div class="kfv2-table-wrap"><table id="table_new_lines" class="kfv2-table"></table></div>
    </section>

    <section class="kfv2-card-block">
        <div class="kfv2-card-block-head"><h3 style="margin:0;font-size:14.5px"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeFinalize')); ?></h3></div><div class="kfv2-card-block-body">
        <div class="kfv2-form-grid">
        ...
        <div class="kfv2-actions"><button type="button" id="btn_process_exchange" class="kfv2-btn kfv2-btn-primary"><?php echo dol_escape_htmltag($langs->trans('TakeposExchangeProcess')); ?></button></div>
