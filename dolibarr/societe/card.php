	...
	if ((!GETPOST('getcustomercode') && !GETPOST('getsuppliercode')) && ($action == 'add' || $action == 'update') && $permissiontoadd) {
		...
		if (!$error) {
			...
			if (GETPOSTINT("private") == 1) {	// Ask to create a contact
				...
				$object->name = dolGetFirstLastname(GETPOST('firstname', 'nohtml'), GETPOST('name', 'nohtml'));
				...
				$object->name_bis			= GETPOST('name', 'nohtml');
				$object->firstname			= GETPOST('firstname', 'nohtml');
			} else {
				$object->name				= GETPOST('name', 'nohtml');
			}
			$object->entity					= ((GETPOSTISSET('entity') && GETPOST('entity') != '') ? GETPOSTINT('entity') : $conf->entity);
			$object->name_alias				= GETPOST('name_alias', 'nohtml');
			...
			$object->prefix_comm			= GETPOST('prefix_comm', 'nohtml');
